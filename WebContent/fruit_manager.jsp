...
<body>
	<div class="navbar navbar-fixed-top">
		<div class="navbar-inner">
			...
			<div class="container">
				<a class="brand" href="fruit_manager.html"><img
					src="img/logo.png">fruit管理系统</a>

				<div class="nav-collapse">
					<ul class="nav">
						<li><a href="index_manager.jsp"><i
								class="icon-black icon-home"></i>首页</a></li>
						<li><a href="intr_manager.jsp"><i class="icon-flag"></i>
								操作说明</a></li>
						<li><a href="login_manager.jsp"><i class="icon-ok"></i>登陆</a></li>
						<li><a href="/logout"><i class="icon-off"></i>退出</a></li>
						<li><a href=""><i class="icon-cog"></i>皮肤</a></li>
					</ul>
					...
					<ul class="nav pull-right">
						<li><a href="#">fruit购物</a></li>
						<li class="divider-vertical"></li>
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown">友情链接<b class="caret"></b></a>
