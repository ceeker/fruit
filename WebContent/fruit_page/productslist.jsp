...
<s:else>
<body data-last="<s:property value="#session.isLast"/>" data-keyword="<s:property value="keyWord"/>" data-hotLast="<s:property value="#session.hotisLast"/>" data-user="<%=userId.toString()%>">
</s:else>
